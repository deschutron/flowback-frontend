...
<div
	class={`dark:bg-darkobject select-none hover:shadow-2xl proposal flex justify-between items-center bg-white gap-8 p-4 border border-gray-200 lg:h-60 xl:h-40 ${Class}`}
